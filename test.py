...
if __name__ == "__main__":
    ...
    # training config
    parser.add_argument('--gpu', type=str, default='-1')   # set -1 to use cpu
    ...
    parser.add_argument('--save_extra', action='store_true', default=True) # whether to save contrast/global images
